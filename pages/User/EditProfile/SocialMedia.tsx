    ...
    <section className="py-16">
        <div className="max-w-screen-lg mx-auto px-4 md:px-8">
            <div className="max-w-md">
                <h1 className="text-gray-800 text-2xl font-extrabold sm:text-3xl">Social Medias</h1>
                <p className="text-gray-600 mt-2">Connect your social media and explore our community</p>
            </div>
