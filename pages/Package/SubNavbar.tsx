...
const SubNavbar = () => {
  return (
    <>
        ...
        <nav
  className="container relative flex w-full flex-wrap items-center justify-between bg-[#FBFBFB] py-2 text-black hover:text-neutral-700 focus:text-neutral-700  lg:py-4 mx-auto"
  data-te-navbar-ref>
